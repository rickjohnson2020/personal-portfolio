...
class Work(models.Model):
    ...
    github = models.CharField('GITHUB', max_length=100, null=True, blank=True)
    link = models.CharField('リンク', max_length=100, null=True, blank=True)
...
class Hobby(models.Model):
    name = models.CharField('趣味', max_length=100)
    image = models.ImageField(upload_to='hobby_images', verbose_name='イメージ画像', null=True, blank=True)
